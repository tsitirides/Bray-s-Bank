import '../styles/SynechronIcon.css'; // Import the CSS file

const SynechronIcon = ({styling}) => {
    return (
        <svg
            className={styling}
            version="1.1"
            ...
            y="0px"
            viewBox="0 0 119 138"
            style={{ enableBackground: 'new 0 0 119 138' }}
            xmlSpace="preserve"
        >
            <path className="st0" d="M82.4,64.3c-1.2,0.9-1.6,1.4-1.6,2.1c-1.2,7.6-3.5,17.5-6.9,22.7c-3.8,5.9-10.2,7.8-17.5,7.8
            ...
            <path className="st1" d="M39.4,81.3c1-0.8,1.2-1.1,1.3-1.6c0.7-8,3.4-21.9,8.8-28.2c3.7-4.5,9.2-6.3,15.7-6.3s11.3,0.8,14.1,4.1
            ...
            <path className="st0" d="M69.2,70.8c0,1.3-0.4,2.6-1.2,3.7s-1.9,1.9-3.2,2.4s-2.7,0.6-4.1,0.4s-2.6-0.9-3.6-1.8s-1.6-2.1-1.9-3.4
                c-0.3-1.3-0.1-2.6,0.4-3.9c0.5-1.2,1.4-2.3,2.6-3c1.2-0.7,2.5-1.1,3.9-1.1c1.9,0,3.7,0.7,5,2C68.5,67.3,69.2,69,69.2,70.8"/>
        </svg>
    );
};

export default SynechronIcon;